...
En los casos donde se tengan que descargar datos de una lista de páginas (crawler), se puede utilizar [Minet](https://github.com/medialab/minet). Aunque para poder utilizarla se requieren conocimientos de la línea de comandos.
