...
6. Una vez que identifiqué las filas, asignar el tipo de información que tendrá cada una de ellas haciendo clic en `➕ Add New Column`. Para cada columna, define un nombre y un tipo de valor con ayuda del `Easy Column Finder`
