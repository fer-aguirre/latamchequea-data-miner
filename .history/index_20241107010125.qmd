...
- En los casos donde se tengan que descargar datos de una lista de páginas , se puede hacer uso de [Minet](https://github.com/medialab/minet). Aunque para poder utilizarla se requieren conocimientos de la línea de comandos.
