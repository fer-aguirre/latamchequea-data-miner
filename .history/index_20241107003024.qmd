...
8. En la sección `Save` asigna un nombre a la receta y una breve descripción sobre qué datos colecta de este sitio web. Por último, si la receta es nueva, guadar
