...
En los casos donde se tenga que descargar datos  de una lista de páginas en las que hay que hacer clic para ver información adicional (crawler), se puede utilizar [Minet](https://github.com/medialab/minet). Aunque para poder utilizarlase requieren conocimientos de la línea de comandos.
