...
7. En la sección `Nav` ubica el botón `✏️ Easy Nav Finder` y localiza el botón que lleve a la siguiente página de la lista. Esto solo es necesario en caso de que se tenga que iterar 
