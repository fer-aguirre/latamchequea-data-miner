...
- Cuando el sitio web tiene una tabla, se puede utilizar otra herramienta llamada [Table Capture](https://chromewebstore.google.com/detail/table-capture/iebpjdmgckacbodjpijphcplhebcmeop) -la mayoría de las veces- se puede descargar directamente

- Para explotar todas las funcionalidades disponibles en Data Miner, ayuda tener conocimientos básicos de HTML y CSS para poder crear selectores más precisos y personalizables.
